...
public class SUNanoforgeCorruptedExtension extends BaseHullMod {
   protected static Object STATUSKEY = new Object();
   public static String MA_DATA_KEY = "shu_module_reloader_data_key";
   ...
   private String[] getIncompatibleIds() {
      return super.spec.getId().equals("specialsphmod_nanoforge_corrupted_extension") ? ALL_INCOMPAT_IDS : null;
   }
   ...
   public void advanceInCombat(ShipAPI ship, float amount) {
      ...
      if (!this.disableExtraEffect) {
         ...
         SUNanoforgeCorruptedExtension.MissileAutoforger data = (SUNanoforgeCorruptedExtension.MissileAutoforger)engine.getCustomData().get(key);
         if (data == null) {
            data = new SUNanoforgeCorruptedExtension.MissileAutoforger();
   ...
   public void addPostDescriptionSection(TooltipMakerAPI tooltip, HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
      if (!isForModSpec && ship != null) {
         ...
         tooltip.addPara(
            ...
            SUStringCodex.SHU_TOOLTIP_PADMAIN,
            Misc.getGrayColor(),
            new String[]{"This is an extension of Arsenal Autoforge and it will remove itself when the main hullmod is removed from the parent module."}
         );
      }
   }
